...
<div style="text-align:center;margin:20px 0px">
<img src="/assets/contour_on_edges.jpg">
</div>
...
<div style="text-align:center;margin:20px 0px">
<img src="/assets/warped_game_grid.jpg">
</div>
...
<div style="text-align:center;margin:20px 0px">
<img src="/assets/predicted_numbers.jpg">
</div>
...
You can see that it takes a couple of seconds for the whole algorithm to pick up a change in the position of the grid in the frame, or of the grid layout itself. However, there is some room for optimization since sometimes I perform some redundant image transformations.
